...
def main():
    ...
    with torch.no_grad():
        for img_path in image_paths:
            ...
            latent_original_size = z.shape[-2:]
            z_for_flow = _resize_latent(z, size=(rf_latent_size, rf_latent_size))

            preds, _ = rk45_sampler(flow_model, z_for_flow, t_eval=t_eval, device=device)
